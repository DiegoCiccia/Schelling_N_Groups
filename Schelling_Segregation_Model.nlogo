globals [pre_rate rate]
patches-own [ race ]

to setup
  clear-all
  ask patches [set race random (number_of_groups + 1)]
  ask patches with [race = 0] [set pcolor black]
  foreach (range 1 (number_of_groups + 1)) [i -> ask patches with [race = i] [set pcolor ((10 * i) + 5)]]
  reset-ticks
end
...
to go
  ...
  foreach (range 1 (number_of_groups + 1)) [i -> ask patches with [race = i] [set pcolor ((10 * i) + 5)]]
  ask patches [ judge ]
  set rate  (pre_rate / (count patches))
  set pre_rate 0
  tick
end

to move
  foreach (range 1 (number_of_groups + 1)) [ i ->
    if race = i
    [ if 8 - count neighbors  with [ race = i ] > count neighbors with [ race = i ] [
      set race 0
      ask one-of patches with [ race = 0 ] [ set race i ]
    ]
  ]
  ]
end
...
to judge
  foreach (range 1 (number_of_groups + 1)) [ i ->
    if race = i
    [set pre_rate (pre_rate + (( count neighbors with [ race = i or race = 0] ) /  8 ))]]
end
@#$#@#$#@
GRAPHICS-WINDOW
210
...
@#$#@#$#@
<experiments>
  <experiment name="Number_of_group_6" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="number_of_group_5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>rate</metric>
  ...
  <experiment name="Number_of_Group_4" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>rate</metric>
  ...
  <experiment name="Number_of_group_3" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>rate</metric>
  ...
  <experiment name="Number_2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>rate</metric>
  ...
  <experiment name="Number_7" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>rate</metric>
  ...
  <experiment name="Number_8" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>rate</metric>
  ...
  <experiment name="Number_9" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>rate</metric>
  ...
  <experiment name="Number_10" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>rate</metric>
